...
import { BigintIsh, CurrencyAmount, Percent, Price, sqrt, Token } from '@ring-protocol/sdk-core'
...
export const computePairAddress = ({
  ...
  const resolvedInitCodeHash = initCodeHash ?? INIT_CODE_HASH_MAP[token0.chainId] ?? INIT_CODE_HASH
...
export class Pair {
  ...
  public static getAddress(tokenA: Token, tokenB: Token): string {
    ...
    return computePairAddress({
      initCodeHash: INIT_CODE_HASH_MAP[tokenA.chainId] ?? INIT_CODE_HASH,
