...
export const V2_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.XLAYER_MAINNET]: '0x630DB8E822805c82Ca40a54daE02dd5aC31f7fcF',
  [ChainId.TRON_MAINNET]: '0x689abaeeed3f0bb3585773192e23224cac25dd41',
  [ChainId.MEGAETH_MAINNET]: '0xbf56488c857a881ae7e3bed27cf99c10a7ab7e50'
}
/**
...
export const V2_ROUTER_ADDRESSES: AddressMap = {
  ...
  [ChainId.XLAYER_MAINNET]: '0xd69B062F140ba4b9a653F5b3468A914927907C0B',
  [ChainId.TRON_MAINNET]: '0x6e0617948fe030a7e4970f8389d4ad295f249b7e',
  [ChainId.MEGAETH_MAINNET]: '0xb73055db2b3a3eae87a331dd88e4a80b43602690'
}
...
const BLAST_SEPOLIA_ADDRESSES: ChainAddresses = {
  ...
  mixedRouteQuoterV1Address: '0x2947892b6bFcd719868f2d7Fe4A3F9A49B0894B9'
}

const STORY_ODYSSEY_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: '0x0000000000000000000000000000000000000000',
  multicallAddress: '0xb3Ad7754f363af676dC1C5be40423FE538a47920',
  quoterAddress: '0x0000000000000000000000000000000000000000',
  v3MigratorAddress: '0x0000000000000000000000000000000000000000',
  nonfungiblePositionManagerAddress: '0x0000000000000000000000000000000000000000',
  tickLensAddress: '0x0000000000000000000000000000000000000000',
...
const STORY_MAINNET_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: '0x0000000000000000000000000000000000000000',
  multicallAddress: '0xb981b930c6b78C4DfDe258eD2a9119ED69fB2faf',
  quoterAddress: '0x0000000000000000000000000000000000000000',
  v3MigratorAddress: '0x0000000000000000000000000000000000000000',
  nonfungiblePositionManagerAddress: '0x0000000000000000000000000000000000000000',
  tickLensAddress: '0x0000000000000000000000000000000000000000',
...
const HYPER_MAINNET_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: '0x0000000000000000000000000000000000000000',
  multicallAddress: '0x793b1b0111Ba64673f983Ea7d7C0aF15a1161bED',
  quoterAddress: '0x0000000000000000000000000000000000000000',
  v3MigratorAddress: '0x0000000000000000000000000000000000000000',
  nonfungiblePositionManagerAddress: '0x0000000000000000000000000000000000000000',
  tickLensAddress: '0x0000000000000000000000000000000000000000',
...
const XLAYER_MAINNET_ADDRESSES: ChainAddresses = {
...
const MEGAETH_MAINNET_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: '0x68b34591f662508076927803c567Cc8006988a09',
  multicallAddress: '0x61f3272a3619d9f20788c6822fed2e5471bfc477',
  quoterAddress: '0x31db60c6a4c71909674094b404597762df424ae7',
  // v3MigratorAddress: '0xed30f6c25fe915dc710f168fa3ab66199ee84454',
  nonfungiblePositionManagerAddress: '0x2b781C57e6358f64864Ff8EC464a03Fdaf9974bA',
  // tickLensAddress: '0xe7a2d824722addcb21e7a203ae7b372bf3a29ec5',
  swapRouter02Address: '0xE5BbEF8De2DB447a7432A47EBa58924d94eE470e',
  ...
  mixedRouteQuoterV1Address: '0x1F1a8dC7E138C34b503Ca080962aC10B75384a27',
  mixedRouteQuoterV2Address: '0x1F1a8dC7E138C34b503Ca080962aC10B75384a27'
}

export const TRON_MAINNET_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: '0xc2708485c99cd8cf058de1a9a7e3c2d8261a995c',
  multicallAddress: '0x32a4f47a74a6810bd0bf861cabab99656a75de9e',
  ...
  mixedRouteQuoterV2Address: '0x0000000000000000000000000000000000000000',
...
const CHAIN_TO_ADDRESSES_MAP: Record<SupportedChainsType, ChainAddresses> = {
  ...
  [ChainId.STORY_ODYSSEY]: STORY_ODYSSEY_ADDRESSES,
  [ChainId.STORY_MAINNET]: STORY_MAINNET_ADDRESSES,
  [ChainId.HYPER_MAINNET]: HYPER_MAINNET_ADDRESSES,
  [ChainId.XLAYER_MAINNET]: XLAYER_MAINNET_ADDRESSES,
  [ChainId.TRON_MAINNET]: TRON_MAINNET_ADDRESSES,
  [ChainId.MEGAETH_MAINNET]: MEGAETH_MAINNET_ADDRESSES
}
